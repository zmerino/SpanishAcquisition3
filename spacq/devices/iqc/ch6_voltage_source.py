...
class Port(AbstractSubdevice):
	...
	def voltage(self, value):
		...
		resulting_voltage = self.calculate_voltage(value) << (20 - self.resolution)
...
class ch6VoltageSource(AbstractDevice):
	"""
	...
	def _gui_setup(self):
		try:
			from .gui.ch6_voltage_source import ch6VoltageSourceSettingsDialog

			return ch6VoltageSourceSettingsDialog
...
name = 'Six channel voltage source'
implementation = ch6VoltageSource
