...
from ..ch6_voltage_source import ch6VoltageSource
...
class Mockch6VoltageSource(MockAbstractDevice, ch6VoltageSource):
	"""
	...
	def __init__(self, *args, **kwargs):
		...
		self.mocking = ch6VoltageSource

		MockAbstractDevice.__init__(self, *args, **kwargs)

	def _reset(self):
		self.mock_state['ports'] = [MockPort() for _ in range(6)]
...
implementation = Mockch6VoltageSource
