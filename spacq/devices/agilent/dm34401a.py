...
class DM34401A(AbstractDevice):
    """
    Interface for Agilent 34401A DM.
    ...
    def auto_zero(self):
        ...
        result = self.ask('sense:zero:auto?')
    ...
    def auto_zero(self, value):
        ...
        self.write('sense:zero:auto {0}'.format(value))
